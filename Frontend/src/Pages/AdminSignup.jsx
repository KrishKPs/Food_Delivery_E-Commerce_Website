...
export function AdminSignup () {
    ...
    async function handleSignup() {  
        ...
        const responce = await axios.post('https://backend-8ew7thslt-krish-patels-projects-3e6b9326.vercel.app/foodapp/admin/signup', user)
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-10">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-lg">
                ...
                <p className="text-black text-center mt-6">
                   ...
                   <Link to="/adminlogin" className="text-black font-medium"> Login</Link>     
                </p>
            </div>
        </div>
    );
