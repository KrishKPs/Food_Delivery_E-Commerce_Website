  ...
  return (
    <>
      <div className="flex justify-between items-center h-16 w-full border-b-2 border-gray-200 px-4 bg-gradient-to-r from-white to-gray-100 shadow-lg transition-all duration-300 ease-in-out">
        {/* Logo */}
        <h1 className="text-3xl font-extrabold text-blue-600 animate-pulse">Zomato</h1>
        ...
        <div className="relative flex items-center">
          <input
            ...
            className="border-2 border-gray-300 rounded-full p-2 pl-10 w-80 focus:outline-none focus:border-blue-500 transition-all"
          />
